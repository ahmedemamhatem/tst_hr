from hrms.payroll.doctype.payroll_entry.payroll_entry import PayrollEntry,get_salary_structure,remove_payrolled_employees,set_fields_to_select,set_searchfield,set_filter_conditions,set_match_conditions
import frappe
...
def get_filtered_employees(
	...
	query = (
		...
		.where(
			...
			& (Employee.status.notin(["Inactive", "Suspended"]))
